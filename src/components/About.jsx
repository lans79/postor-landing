        ...
        <div className="container">
          ...
          <div className="team-grid">
            {[
              ...
              { initial: 'А', photo: '/andrey.jpg',  name: 'Андрей', role: 'Коммуникатор · Развитие', desc: 'Голос агентства и первое лицо для новых клиентов. Умеет слышать задачу бизнеса и превращать её в конкретный результат. Если вы здесь — скорее всего, именно Андрей привёл вас сюда.' },
